...
guiText = {}
guiText.tip = "You can manage stations which you want listen to. Double click on list will change station from used list to not used, and vice versa. You favourit stations are saved into xml file."
guiText.credits = "Scripters:\nH5N1[PL] (skype: upelson)\nMajkel (skype: majkelasty)\n\nRadios list:\nMajkel\nH5N1[PL]\n\nBeta testers:\nKowal\nBanned\nMarzecky"
guiText.wanna = "Visit " .. site .. " and send\nnew stations to admin"
...
function createRadioListGui ()
	if usingGui == false then
		...
		radioListGui.closeButton = guiCreateButton(radioListGui.windowsizeX - 70,58 + radioListGui.gridLenght,70,25,"Close",false,radioListGui.window)
		...
		radioListGui.infoLabel = guiCreateLabel (14, 58 + radioListGui.gridLenght, 28, 25, "Tip", false, radioListGui.window)
		radioListGui.creditsLabel = guiCreateLabel (50, 58 + radioListGui.gridLenght, 40, 25, "Credits", false, radioListGui.window)
		radioListGui.wantLabel = guiCreateLabel (110, 58 + radioListGui.gridLenght, 110, 25, "Want more radios?", false, radioListGui.window)
		showCursor (true)
...
addCommandHandler ("radios", createRadioListGui)
