...
function onClientResourceStart()
    sound = playSound( "gfx/music/aud.mp3", true )
...
function crown()
        dxDrawImage(x*0, y*0, x*1362, y*768, "gfx/img/wallpaper.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(x*612, y*100, x*135, y*111, "gfx/img/logo.png",logo, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(x*25, y*200, x*445, y*321, "gfx/img/ganglogo2.png",0, 0, 0, tocolor(255, 255, 255, 255), false)
	...
	if cursorPosition(x*764, y*422, x*148, y*52) then cor[3] = tocolor(255, 165, 0, 255) end
       ...
       -- dxDrawRectangle(x*613, y*422, x*151, y*52, cor[2], false)
        ...
        dxDrawText("Login", x*504, y*436, x*586, y*464, tocolor(255, 255, 255, 255), 1.00, dxfont0_font, "left", "top", false, false, true, false, false)--Login
        dxDrawText("  ( ͡° ͜ʖ ͡°)", x*643, y*436, x*725, y*464, tocolor(255, 255, 255, 255), 1.00, dxfont0_font, "left", "top", false, false, true, false, false)--Sign in without login
        dxDrawText("Register", x*794, y*436, x*876, y*464, tocolor(255, 255, 255, 255), 1.00, dxfont0_font, "left", "top", false, false, true, false, false)--Register

        dxDrawText("Remember Login", x*542, y*389, x*627, y*418, tocolor(255, 255, 255, 255), 1.00, dxfont0_font, "left", "top", false, false, false, false, false)--Remember login
        dxDrawText("Show Password", x*754, y*389, x*839, y*418, tocolor(255, 255, 255, 255), 1.00, dxfont0_font, "left", "top", false, false, false, false, false)--Show Password
...
function loginClick(botao, state)
	...
	elseif cursorPosition(x*0, y*0, x*0, y*0) then
    	stopSound( sound )
