...
local zombieWalkingStyle = 120 --Change walking style of zombies with one ID from this list: https://wiki.multitheftauto.com/wiki/SetPedWalkingStyle
local minSpawnAtOnce = 1 --Amount of zombies spawning at once when the spawninterval decides to spawn zombies.
local maxSpawnAtOnce = 3
